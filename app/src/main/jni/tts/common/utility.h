...
__attribute__ ((unused)) static unsigned long spliteData(char *pData, const char *delim, vector<string> &vData)
{
    char *pch;
...
__attribute__ ((unused)) static unsigned long spliteData(char *pData, const char *delim, set<string> &setData)
{
    char *pch;
